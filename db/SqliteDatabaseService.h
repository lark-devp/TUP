...
public:
    ...
    bool saveAuthToken(int userId, const QString& token) override;
    void clearAuthToken(int userId) override;
    QVariantMap findUserByToken(const QString& token) override;
