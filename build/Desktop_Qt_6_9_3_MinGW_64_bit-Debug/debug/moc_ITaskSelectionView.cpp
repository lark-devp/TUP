...
void ITaskSelectionView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->editTaskRequested((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->statisticsRequestedForTask((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 3: _t->allTasksStatisticsRequested(); break;
        case 4: _t->addTaskRequested(); break;
        case 5: _t->synchronizationRequested(); break;
        case 6: _t->refreshRequested(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ITaskSelectionView::*)(const QString & )>(_a, &ITaskSelectionView::taskSelectedForTimer, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ITaskSelectionView::*)(const QString & )>(_a, &ITaskSelectionView::editTaskRequested, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (ITaskSelectionView::*)(const QString & )>(_a, &ITaskSelectionView::statisticsRequestedForTask, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (ITaskSelectionView::*)()>(_a, &ITaskSelectionView::allTasksStatisticsRequested, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (ITaskSelectionView::*)()>(_a, &ITaskSelectionView::addTaskRequested, 4))
            return;
        if (QtMocHelpers::indexOfMethod<void (ITaskSelectionView::*)()>(_a, &ITaskSelectionView::synchronizationRequested, 5))
            return;
        if (QtMocHelpers::indexOfMethod<void (ITaskSelectionView::*)()>(_a, &ITaskSelectionView::refreshRequested, 6))
            return;
    }
}
...
// SIGNAL 1
void ITaskSelectionView::editTaskRequested(const QString & _t1)
{
